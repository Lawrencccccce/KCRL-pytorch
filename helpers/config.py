...
train_arg.add_argument('--lr2_start', type=float, default=0.001, help='actor learning rate')
train_arg.add_argument('--lr2_decay_step', type=int, default=5000, help='lr1 decay step')
train_arg.add_argument('--lr2_decay_rate', type=float, default=0.96, help='lr1 decay rate')
